...
INSERT INTO IndividuMonstre( nom, niveau, attaque, defense, vitesse, attaqueSpe, defenseSpe, pvMax, potentiel, exp, pv, espece_id, entraineur_equipe_id)
VALUES ('springleaf',3,22,25,  8000, 12, 100, 1, 1, 50, 1, 1, 2),
       ('aquamy',3,22,25,  8000, 12, 100, 1, 1, 50, 1, 7, 1),
       ('bugsyface',3,22,25,  8000, 12, 100, 1, 1, 50, 1, 10, 1),
       ('aquamy',3,22,25,  8000, 12, 100, 1, 1, 50, 1, 4, 3),
       ('aquamy',3,22,25,  8000, 12, 100, 1, 1, 50, 1, 13, 3);
